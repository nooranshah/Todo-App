...
export interface ITagClient {
    create(command: CreateTagsToTodoItemCommand): Observable<number>;
...
export class CreateTagsToTodoItemCommand implements ICreateTagsToTodoItemCommand {
    todoItemId?: number;
    tagNames?: string | undefined;

    constructor(data?: ICreateTagsToTodoItemCommand) {
        if (data) {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.tagNames = _data["tagNames"];
        }
    }

    static fromJS(data: any): CreateTagsToTodoItemCommand {
        data = typeof data === 'object' ? data : {};
        let result = new CreateTagsToTodoItemCommand();
        result.init(data);
        return result;
    }
...
export interface ICreateTagsToTodoItemCommand {
    todoItemId?: number;
    tagNames?: string | undefined;
}
